...
import static com.codepath.apps.restclienttemplate.R.id.ivEmbeddedImage;
...
//    public void addAll(List<? extends Tweet> list){
//        mTweets.addAll(list);
//        notifyDataSetChanged();
//    }
...
//            tvBody = (TextView) view.findViewById(tvBody);
